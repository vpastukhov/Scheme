...
isList [x] = case flattenList x of Right []  -> return (Boolean True)
                                   Right lst -> return (Boolean True)
...
isPair [x] = case x of Pair _ _ -> return (Boolean True)
                       _        -> return (Boolean False)
...
isNull [x] = case flattenList x of Right []  -> return (Boolean True)
                                   _   -> return (Boolean False)
